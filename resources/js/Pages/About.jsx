    ...
    return (
        <FrontPageLayout>
            ...
            <section className="intro">
                <h2>About us</h2>
                <p>
                    Learneez is designed to support students with special
                    educational needs. Our platform provides interactive tools
                    to enhance learning experiences, ensuring every student
